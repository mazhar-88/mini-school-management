...
import TeacherAssignmentTable from "./teacher-assigment-table/TeacherAssignmentTable";
import TeacherAssignmentModal from "./teacher-assigment-modal/TeacherAssignmentModal";
...
function TeacherAssignment() {
    ...
    const loadData = async (page = 1) => {
        try {
            ...
            const url = `/assignment?${param.toString()}`;
